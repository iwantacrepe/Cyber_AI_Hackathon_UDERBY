...
def summarize_file(file_path: str, language: str) -> str:
    ...
    system_prompt = (
    f"You are 'Nyay-Summarizer', a multilingual Legal Document Summarization Agent.\n"
    ...
    "- Detailed explanation of each issue and its implications.\n"
